            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="card card-login">
                    <div class="card-header card-header-rose text-center">
                        <h4 class="card-title" style="color: white !important;">{{ __('Login') }}</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" class="form-control" name="password" placeholder="{{ __('Password...') }}" value="{{ old('password') }}" required />
                        </div>
